...
INSERT INTO "new_Livro" ("autorId", "categoriaId", "criadoEm", "editora", "id", "isbn", "status", "titulo") SELECT "autorId", "categoriaId", "criadoEm", "editora", "id", "isbn", "status", "titulo" FROM "Livro";
DROP TABLE "Livro";
